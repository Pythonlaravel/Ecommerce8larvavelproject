							...
							<li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<a href="{{route('product.details',['slug'=>$item->model->slug])}}" class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistlistToCart('{{$item->rowId}}')">Move To Cart</a>
